...
export const Logout = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} fill="currentColor" className="bi-box-arrow-left mr-1 bi" viewBox="0 0 16 16">
...
export const FileShareee = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-people-fill" viewBox="0 0 16 16">
