...
export const Logout = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} fill="currentColor" className="bi bi-box-arrow-left mr-1" viewBox="0 0 16 16">
...
export const Dashboard = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-grid-1x2" viewBox="0 0 16 16">
...
export const DashboardFill = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-grid-1x2-fill" viewBox="0 0 16 16">
...
export const Share = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-share-fill" viewBox="0 0 16 16">
